...
extern mp_obj_t drawBitmap(mp_obj_t a_xywh, mp_obj_t a_bitmap);
extern mp_obj_t drawBitmapWithKeyColor(mp_obj_t a_xywh, mp_obj_t a_bitmap, mp_obj_t a_keycolor);
#pragma endregion
