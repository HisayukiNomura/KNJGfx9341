...
extern "C" void __wrap_cyw43_cb_procpindess_ethernet(void *cb_data, int itf, size_t len, const uint8_t *buf) {
	(void)cb_data;
	(void)itf;
...
extern "C" PinStatus cyw43_digitalRead(pin_size_t pin) {
	...
	if (pin < 64) {
		...
		#endif  // defined(PICO_CYW43_SUPPORTED)
	#endif      // defined(PICO_CYW43_SUPPORTED)
#endif          // defined(MICROPY_BUILD_TYPE)